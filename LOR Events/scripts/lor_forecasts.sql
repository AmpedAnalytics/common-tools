...
WHERE MNT.DESCRIPTION = 'LRC/LOR1/LOR2/LOR3'
AND MND.EXTERNALREFERENCE LIKE '%forecast%'
AND MND.EXTERNALREFERENCE NOT LIKE '%cancellation%'
AND MND.EXTERNALREFERENCE NOT LIKE '%correction%'
AND MND.EXTERNALREFERENCE NOT LIKE '%update%'
AND MND.EXTERNALREFERENCE NOT LIKE '%upadte%'
AND MND.EXTERNALREFERENCE NOT LIKE '%revis%'
AND MND.EXTERNALREFERENCE NOT LIKE '%amend%';