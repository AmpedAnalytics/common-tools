...
*	The suggested value is 3 MW. To capture short trips of Stanwell PS units, which have a
...
*	based on INITIALMW vs the @THRESHOLD parameter.
****************************************************************************************************/
